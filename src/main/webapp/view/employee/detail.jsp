        ...
        <div class="center">
            <div class="card" style="width: 440px;">
                <div class="card-header bg-primary">
                    <h1 style="margin-top: 16px; color: white;">Chi tiết nhân viên</h1>
                </div>
                ...
                <div class="card-footer">
                    <p><a href="${pageContext.request.contextPath}/employee?action=list" class="btn btn-primary" style="margin-top: 12px;">Back</a></p>
                </div>
            </div>
        </div>
    </div>
