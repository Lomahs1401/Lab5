...
<body>
    <div class="container">
        <div class="center">
            <h1 style="text-align: center; margin-top: 100px;">Cập nhật nhân viên</h1>
            <form action="${pageContext.request.contextPath}/employee?action=update" method="POST"
                  name="update_employee_form" class="mt-16 needs-validation" novalidate>
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="${employee.getId()}" id="id" name="id" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="${employee.getPhone()}" id="phone" name="phone" required>
                            <div class="valid-feedback">Hợp lệ</div>
                            <div class="invalid-feedback">Trường này không được để trống</div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="${employee.getAddress()}" id="address" name="address" required>
                            <div class="valid-feedback">Hợp lệ</div>
                            <div class="invalid-feedback">Trường này không được để trống</div>
                        </div>
                        <div class="form-group">
                            <label for="image">Ảnh:</label>
                            <input type="text" class="form-control" value="${employee.getImage()}" id="image" name="image" required>
                            <div class="valid-feedback">Hợp lệ</div>
                            <div class="invalid-feedback">Trường này không được để trống</div>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="department_id" id="list-department">
                                <c:forEach var="department" items="${requestScope['departments']}">
                                    <option value="${department.getId()}" <c:out value="${department.getName() == departmentName ? 'selected' : '' }"/>>
                ...
                <div class="controls">
                    <a href="${pageContext.request.contextPath}/employee?action=list" type="button" class="btn btn-primary">Back</a>
